                        ...
                        {if $department}
                            ...
                            <div class="ty-grid-list__item ty-quick-view-button__wrapper">
                                ...
                                <div class="ty-grid-list__item-name">
                                    <bdi>           
                                        <a href="{"departments.department?department_id={$department.department_id}"|fn_url}">Отдел: {$department.department}</a>
                                    </bdi>                          
                                </div>
                                <div class="ty-grid-list__item-name">
                                    <bdi>           
                                        <a href="{"departments.department?department_id={$department.department_id}"|fn_url}">Руководитель: {$department.firstname} {$department.lastname}</a>
                                    </bdi>                          
                                </div>
                            </div>
                        {/if}
