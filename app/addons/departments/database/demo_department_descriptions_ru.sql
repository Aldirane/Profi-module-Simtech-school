REPLACE INTO ?:department_descriptions (`department_id`, `lang_code`, `department`, `description`) VALUES (
    ...
    'ru',
    'First department',
    '<p>Бизнес-задача</p>\r\n<ul><li>Создать интерфейс управления списком отделов на базе CS-Cart последней версии;</li><li>Создать страницы со списком отделов и карточкой отдела для повышения лояльности покупателей сайта;</li></ul>'
);
REPLACE INTO ?:department_descriptions (`department_id`, `lang_code`, `department`, `description`) VALUES (
    42,
    'ru',
...
REPLACE INTO ?:department_descriptions (`department_id`, `lang_code`, `department`, `description`) VALUES (57,'ru','New department','');